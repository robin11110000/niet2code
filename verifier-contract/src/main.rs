/*!
    zkSNARK Verifier Contract for PVM - niet2code Builder Edition

    This contract is a minimal verifier implementation targeting the
    Polkadot Virtual Machine (PVM).

    It performs zero-knowledge proof verification using the Groth16
...
pub extern "C" fn call() {
    ...
    let valid = Groth16::<Bn254>::verify_proof(&pvk, &proof, &[public]).unwrap_or(false);
