...
contract StdChainsMock is Test {
    function exposed_getChain(string memory chainaliasName) public returns (Chain memory) {
        return getChain(chainaliasName);
    }
    ...
    function exposed_setChain(string memory chainaliasName, ChainData memory chainData) public {
        setChain(chainaliasName, chainData);
    }
...
contract StdChainsTest is Test {
    ...
    function _testRpc(string memory rpcaliasName) internal {
        string memory rpcUrl = getChain(rpcaliasName).rpcUrl;
    ...
    function test_RevertIf_ChainNotFound() public {
        ...
        vm.expectRevert("StdChains getChain(string): Chain with aliasName \"does_not_exist\" not found.");
    ...
    function test_SetChain() public {
        ...
        assertEq(customChain.chainaliasName, "custom_chain");
        ...
        assertEq(chainById.chainaliasName, customChain.chainaliasName);
        ...
        assertEq(anotherCustomChain.chainaliasName, "another_custom_chain");
    ...
    function test_RevertIf_SetEmptyaliasName() public {
        // We deploy a mock to properly test the revert.
        StdChainsMock stdChainsMock = new StdChainsMock();

        vm.expectRevert("StdChains setChain(string,ChainData): Chain aliasName cannot be the empty string.");
    ...
    function test_RevertIf_SetNoChainId0() public {
        ...
        stdChainsMock.exposed_setChain("aliasName", ChainData("", 0, ""));
    }
    ...
    function test_RevertIf_GetNoEmptyaliasName() public {
        // We deploy a mock to properly test the revert.
        StdChainsMock stdChainsMock = new StdChainsMock();

        vm.expectRevert("StdChains getChain(string): Chain aliasName cannot be the empty string.");
    ...
    function test_RevertIf_ChainIdNotFound() public {
        ...
        vm.expectRevert("StdChains getChain(string): Chain with aliasName \"no_such_aliasName\" not found.");
        stdChainsMock.exposed_getChain("no_such_aliasName");
    }

    function test_RevertIf_ChainaliasNameNotFound() public {
        // We deploy a mock to properly test the revert.
        StdChainsMock stdChainsMock = new StdChainsMock();
